...
<head>
    ...
    <!-- Primary Meta Tags -->
    <meta name="title" content="Druryism SLM Evaluation Report">
    <meta name="description" content="Quantitative and qualitative evaluation of the local fine-tuned SLM (base Phi-3-mini + QLoRA adapters) vs the baseline model in translating football scenes into poetic commentaries.">
    <meta name="keywords" content="Peter Drury, SLM evaluation, MLX, QLoRA, Apple Silicon, benchmark, local LLM, text metrics">
    <meta name="author" content="dhnam">

    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="https://catlikeflyer.github.io/Druryism/eval_report.html">
    <meta property="og:title" content="Druryism SLM Evaluation Report">
    <meta property="og:description" content="Quantitative and qualitative evaluation of the local fine-tuned SLM (base Phi-3-mini + QLoRA adapters) vs the baseline model in translating football scenes into poetic commentaries.">
    <meta property="og:image" content="https://raw.githubusercontent.com/catlikeflyer/Druryism/main/mock_match_pitch.jpg">

    <!-- Twitter -->
    <meta property="twitter:card" content="summary_large_image">
    <meta property="twitter:url" content="https://catlikeflyer.github.io/Druryism/eval_report.html">
    <meta property="twitter:title" content="Druryism SLM Evaluation Report">
    <meta property="twitter:description" content="Quantitative and qualitative evaluation of the local fine-tuned SLM (base Phi-3-mini + QLoRA adapters) vs the baseline model in translating football scenes into poetic commentaries.">
    <meta property="twitter:image" content="https://raw.githubusercontent.com/catlikeflyer/Druryism/main/mock_match_pitch.jpg">
    ...
    <main>
        ...
        <div style="background: rgba(239, 68, 68, 0.05); border: 1px dashed rgba(239, 68, 68, 0.25); border-radius: 1.25rem; padding: 1.5rem 2rem; display: flex; flex-direction: column; gap: 0.75rem; text-align: left; max-width: 1400px; margin: 0 auto 1.5rem auto; box-shadow: 0 4px 30px rgba(239, 68, 68, 0.02); line-height: 1.6;">
            ...
            <p style="color: var(--text-secondary); font-size: 0.9rem; margin: 0;">
                This project runs exclusively on <strong>Apple Silicon (M-series) Mac devices</strong> using Apple's local <strong>MLX framework</strong> for neural model loading and inference. It is not compatible with Windows, Linux, or Intel-based Macs out-of-the-box. To automatically generate the dataset, train adapters, run evaluations, and execute the final vision-to-commentary pipeline, you can run the e2e script: <code>./run_all.sh</code>.
            </p>
            ...
            <p style="color: var(--text-secondary); font-size: 0.9rem; margin: 0; font-style: italic;">
                Deepest respect and shout-out to the legendary <a href="https://en.wikipedia.org/wiki/Peter_Drury" target="_blank" style="color: #a5b4fc; text-decoration: underline;">Peter Drury</a>, the poet laureate of modern football commentary, whose unparalleled vocabulary, passion, and dramatic delivery inspired this experimental project!
            </p>
        </div>
